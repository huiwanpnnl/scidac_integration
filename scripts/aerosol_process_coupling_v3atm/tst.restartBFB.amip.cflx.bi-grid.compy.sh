...
readonly BRANCH="huiwapnpnnl/atm/chemUCI-chemMZT-MOSAIC-cflx_AMIP" # This is the branch in ${repo} to be cloned.
readonly CHECKOUT="v3atm_cflx"  # This is the local subdir into which the E3SM code will be cloned
