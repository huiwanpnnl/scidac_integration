...
readonly CASE_NAME="tst.restartBFB.amip.chemUCI_Linozv3"
# If this is part of a simulation campaign, ask your group lead about using a case_group label
# readonly CASE_GROUP=""

# Code and compilation
readonly CHECKOUT="v3atm"
readonly BRANCH="tangq/atm/chemUCI_amip" # 210a3ee7d3b1e568aa0d2d8cd60554c848a21898, tangq/atm/chemUCI_amip as of 20220918
