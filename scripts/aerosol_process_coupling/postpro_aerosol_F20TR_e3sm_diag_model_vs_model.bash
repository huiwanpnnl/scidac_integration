...
#SBATCH  --job-name=mam_manual
#SBATCH  --account=esmd
#SBATCH  --nodes=1
#SBATCH  --output=m2m_manual_F20TR.o%j
#SBATCH  --exclusive
...
readonly CASE_CTRL="v2.LR.amip_0101"
readonly CASE_TEST="20220519.v2.LR.bi-grid.amip.cflx_cpl_opt_2.compy"

readonly SHORTNAME_CTRL="v2.LR.amip_0101"
readonly SHORTNAME_TEST="20220519.v2.cflx_cpl"

readonly CLIMO_DIR_CTRL="/compyfs/${USER}/scidac4_int/E3SMv2/${CASE_CTRL}/post/atm/180x360_aave/clim/30yr"
readonly CLIMO_DIR_TEST="/compyfs/${USER}/scidac4_int/aerosol/${CASE_TEST}/post2_20220720-20220804/atm/180x360_aave/clim/30yr"
