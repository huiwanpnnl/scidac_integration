...
readonly CASE_NAME="dribble_F2010"
...
! Use dribbling for coupling mac-mic subcycles with the rest of EAM
...
case_setup() {
    ...
    # Setup PE layout
    for ntasks_comp in NTASKS_ATM  NTASKS_CPL  NTASKS_OCN  NTASKS_WAV  NTASKS_GLC  NTASKS_ICE  NTASKS_ROF  NTASKS_LND
    do
      ./xmlchange --id $ntasks_comp --val $NTASKS
    done
